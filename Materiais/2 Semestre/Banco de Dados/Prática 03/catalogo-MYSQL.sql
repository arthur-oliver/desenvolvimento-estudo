...
create table cd_categoria(
   cat_codigo int primary key, #corrigi at_codigo para cat_codigo
...
insert into cd values (1,'CD1',10,CURDATE(),1,null); #substitui NOW por CURDATE (não pede hora)
insert into cd values (2,'CD2',12,CURDATE(),2,1);
insert into cd values (3,'CD3',20.00,CURDATE(),1,null);
