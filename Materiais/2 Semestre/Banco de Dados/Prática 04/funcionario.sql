...
(tel_codigo int primary key,
 func_cod int references funcionario(fun_cod),
 tel_numero int );

insert into departamento values (1,'RH',0);
insert into departamento values (2,'Vendas',0);
insert into departamento values (3,'Informática',0);
